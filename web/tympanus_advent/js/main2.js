	...
	function Calendar(el) {
		...
		this.calendarDays.forEach(function(d, pos) {
			...
			var day = new Day({
					...
					image: d.getAttribute('data-bg-image'),
			...
			if (false === d.hasAttribute('data-inactive')) {
